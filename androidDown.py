...
╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝╚═════╝       ╚═════╝  ╚═════╝  ╚══╝╚══╝ ╚═╝  ╚═══╝   
 ...
 ● https://github.com/kikiokol/AndroidDown/
...
class commands():
    ...
    def adb_install():
        ...
        if(detect_url(apkPath)):
            #Download apk
            urllib.request.urlretrieve(apkPath, "apkfile.apk")
            apkPath = "apkfile.apk"
        else:
            os.system("mv {} apkfile.apk".format(apkPath))
        try:
            output = commands.cli_command("adb install apkfile.apk")
            print(output)
        except:
